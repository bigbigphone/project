...
cout << shop_name << " is in stock. " << quantity <<
		" pieces are available." << endl;
...
cout << name << "  " << quantity << "Pieces" << "  $" << price
		<< "  " << manufacturer << endl;
...
void insert_new_function (string product_name, int product_amount,
...
fout << product_name << " " << product_amount << " " << product_price
	<< " " << product_manufacturer << endl;
      
fout.close ();
      
cout << product_name <<
	" is inserted to the commodity inventory system." << endl;
...
fout << temp_name << " " << temp_amount << " " << temp_price << " "
	    << temp_manufacturer << endl;
...
fout << temp_name << " " << total_amount << " " << temp_price <<
	    " " << temp_manufacturer << endl;
	  
cout << "The fore-updated product quantity is " << temp_amount <<
	    endl;
...
cout << "The quantity of " << product_name << " is fewer than "
		<< product_amount << "!" << endl;
...
void update_function (string product_name, string new_product_name,
			 int new_product_quantity, double new_product_price,
			 string new_product_manufacturer);
...
fin >> orginal_product_quantity >> orginal_product_price >>
		orginal_product_manufacturer;
...
orginal_product_manufacturer =
			new_product_manufacturer;
		    
}
		
}
	      
fout << orginal_product_name << " " << orginal_product_quantity
		<< " " << orginal_product_price << " " <<
		orginal_product_manufacturer << endl;
...
insert_new_function (product_name, product_amount,
...
cout <<
		    " Please Input The Corresponding Function Number :";
...
string new_product_name =
		    'nothing', new_product_manufacturer = 'nothing';
...
cout << " 4 ---- Change Commodity Manufacturer" <<
			endl;
		      
cout << " 0 ---- Finishing the Changing Process<<"
			endl;
...
cout <<
			    " Please Input New Product Manufacturer : ";
...
update_function (product_name, new_product_name,
				    new_product_quantity, new_product_price,
				    new_product_manufacturer);
